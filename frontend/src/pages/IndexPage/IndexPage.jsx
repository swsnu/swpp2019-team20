...
const backgroundImage = 'https://images.pexels.com/photos/462383/pexels-photo-462383.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940';
const styles = (theme) => ({
  background: {
    ...
    <fragment>
      <IndexPageLayout backgroundClassName={classes.background}>
        ...
        <Typography color="inherit" align="center" variant="h5" className={classes.h5}>
          You don&apos;t need to feel awkward to say &quot;GIVE MY MONEY BACK!&quot;
          <br />
