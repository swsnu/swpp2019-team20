...
import {Button as MyButton, Header, Image, Modal} from "semantic-ui-react";
...
const LatestOrders = (props) => {
  const {
    className, TxList, onClickBtn, isBtnDisabled, username, popUp, handleChange, onSubmit, isDisable, ...rest
  } = props;
